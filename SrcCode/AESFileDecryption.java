...
public class AESFileDecryption {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Step 1: Decrypt File
        String encryptedFile = "./EncryptedFiles/enc_justinbieber.txt"; // File with encrypted data
        String decryptedFile = "./DecryptedFiles/dec_justinbieber.txt"; // Output file to store decrypted text
        decryptFile(secretKey, encryptedFile, decryptedFile);

        System.out.println("Decryption completed. Decrypted data saved in DecryptedFiles.");
    }
